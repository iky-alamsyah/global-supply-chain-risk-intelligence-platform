    ...
    <div class="country-hero-inner">
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-2">
            <div class="d-flex align-items-center gap-3">
                <a href="{{ route('admin.countries.index') }}" class="hero-back-btn">
            ...
            <div class="d-flex align-items-center gap-2">
                <a href="{{ route('admin.countries.edit', $country) }}" class="btn btn-sm btn-light d-flex align-items-center gap-1.5" style="border-radius:var(--radius-sm); font-weight:600; font-size:.8rem; padding:6px 12px;">
                    <i class="bi bi-pencil-fill text-primary"></i> Edit Registry
                </a>
        ...
        <div class="d-flex flex-wrap gap-2 mt-3">
            <span class="hero-badge"><i class="bi bi-globe2 me-1"></i>ISO3: {{ $country->iso3 }}</span>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    countryMap.setView([{{ $country->latitude ?? 0 }}, {{ $country->longitude ?? 0 }}], 5);
    ...
    L.marker([{{ $country->latitude ?? 0 }}, {{ $country->longitude ?? 0 }}], { icon: customIcon })
        .addTo(countryMap)
        .bindPopup(`
    ...
    if (bounds.length > 0) {
        ...
        portMap.setView([{{ $country->latitude ?? 0 }}, {{ $country->longitude ?? 0 }}], 5);
    }

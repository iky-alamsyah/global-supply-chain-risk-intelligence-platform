...
<div class="page-header mb-4">
    <div>
        ...
        <p class="page-header-sub mb-0">Manage your administrator account information, email, and password.</p>
    </div>
</div>
...
<div class="row g-4">
    ...
    <div class="col-lg-4">
        <div class="card border-0 shadow-sm text-center p-4" style="border-radius: var(--radius-md); background: var(--surface);">
            <div class="position-relative d-inline-block mx-auto mb-3">
                ...
                @else
                    <div class="rounded-circle d-flex align-items-center justify-content-center mx-auto text-white fw-bold shadow-sm" 
                         style="width: 120px; height: 120px; font-size: 3rem; background: var(--danger);">
            ...
            <span class="badge bg-danger mb-4" style="font-size: .75rem; border-radius: 99px; padding: .35rem .8rem;">
                <i class="bi bi-shield-lock-fill me-1"></i>{{ strtoupper($user->role) }}
            </span>
            ...
            <div class="border-top pt-3 text-start">
                ...
                <div class="d-flex justify-content-between mb-2">
                    <span class="text-muted" style="font-size: .8rem;">Last Login</span>
                    <strong class="text-muted" style="font-size: .8rem;">—</strong>
                </div>
            </div>
        </div>
    </div>
